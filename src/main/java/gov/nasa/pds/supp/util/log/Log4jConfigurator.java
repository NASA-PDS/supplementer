package gov.nasa.pds.supp.util.log;
...
public class Log4jConfigurator
{
    ...
    public static void configure(String verbosity, String filePath) 
    {
        ...
        cfg.setConfigurationName("Supplementer");
        ...
        LoggerComponentBuilder defLog = cfg.newLogger("gov.nasa.pds.supp", level);
        cfg.add(defLog);
    ...
    private static void addFileAppender(ConfigurationBuilder<BuiltConfiguration> cfg, String name, String filePath)
    {
        ...
        if(filePath == null)
        {
            File dir = new File("/tmp/supplementer");
            dir.mkdirs();
            filePath = "/tmp/supplementer/supplementer.log";
        }
